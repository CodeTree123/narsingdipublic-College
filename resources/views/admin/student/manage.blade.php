...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-7">
                    <h6>Student Info Of <b class="badge badge-success"></b></h6>
                </div>
                <div class="col-sm-5">
            ...
            <form method="GET" action="{{ route('admin.student.search') }}">
                <div class="row mb-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Roll</label>
                            <input type="text" class="form-control" name="roll" placeholder="Enter ...">
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($category->student_image == Null)
                                            <img src="{{asset('/')}}public/admin/ma.png" alt="User Image" height="70px" width="70px">
                                            @else
                                            <img src="{{asset('/')}}{{$category->student_image}}" alt="User Image" height="70px" width="70px">
                                            @endif
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger text-light" onclick="deleteTag({{ $category->id }})"><i class="fas fa-trash-alt"></i></button>
                                            ...
                                            <a href="{{ route('admin.student.search_exam_wise_result',['id'=>$category->id]) }}" type="button" class="btn btn-success"><i class="fas fa-clipboard-list"></i></a>
