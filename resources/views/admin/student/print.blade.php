...
<body>
    ...
    <div class="container" style="margin-left: 250px;">
        <div class="row">
            ...
            <div class="col-md-6 mt-3">
                <h5 style="font-size: 18px;"><b>Exam Type:</b> {{ $newExam1 }}</h5>
            </div>
            <div class="col-md-6 mt-3">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($category->written_exam < 22 ) <b>Failed</b>
                                ...
                                @if($category->written_exam < 45 ) <b>Failed</b>
                                    {{ $category->written_exam }}
                                    @else
                                    {{ $category->written_exam }}
                                    @endif
                                    @else
                                    @if($category->written_exam < 32 ) <b>Failed</b>
                                        {{ $category->written_exam }}
                                        @else
                                        {{ $category->written_exam }}
                                        @endif
                        ...
                        <td>
                            ...
                            @else
                            @if($category->mcq_exam < 11) Failed {{ $category->mcq_exam }} @else {{ $category->mcq_exam }} @endif @endif @else @if($category->mcq_exam == NULL)
                                N/A
                                @else
                                @if($category->mcq_exam < 13) Failed {{ $category->mcq_exam }} @else {{ $category->mcq_exam }} @endif @endif @endif </td>

                        <td>{{ $category->wm_per }} </td>
                        ...
                        <td>
                            ...
                            $category->subject_id == 11 || $category->subject_id ==15||
                            $category->subject_id == 18 || $category->subject_id == 23 )
                            @if($category->written_exam < 22 || $category->mcq_exam < 11 ) F @else {{ $category-> gradeLetter   }} @endif @endif @if($category->subject_id == 2 || $category->subject_id == 10 || $category->subject_id == 17 )
                                    @if($category->written_exam < 45 ) @if(empty($category->mcq_exam||$category->written_exam < 45 )) {{ $category-> gradeLetter }} @else F @endif @else {{ $category-> gradeLetter   }} @endif @endif @if($category->subject_id == 1 || $category->subject_id == 9 ||
                                            ...
                                            @if($category->written_exam < 32 || $category->mcq_exam < 13 ) F @else {{ $category-> gradeLetter   }} @endif @endif <!--first-->
                        </td>
                        <!-- Grade point  -->
                        </td>
                        <td>
                            ...
                            $category->subject_id == 11 || $category->subject_id ==15||
                            $category->subject_id == 18 || $category->subject_id == 23 )
                            @if($category->written_exam < 22 || $category->mcq_exam < 11 ) 0 @else {{ $category-> gradePoint   }} @endif @endif @if($category->subject_id == 2 || $category->subject_id == 10 || $category->subject_id == 17 )
                                    @if($category->written_exam < 45 ) @if(empty($category->mcq_exam||$category->written_exam < 45 )) <span class="badge badge-success">
                                            ...
                                            $category->subject_id == 24 || $category->subject_id == 25||
                                            $category->subject_id == 26 )
                                            @if($category->written_exam < 32 || $category->mcq_exam < 13 ) 0 @else {{ $category-> gradePoint   }} @endif @endif </td>
                    </tr>
                    </tbody>
                    @endforeach
    ...
    <div class="container">
        <div class="row">
            ...
            <div>
                <center style="margin-left: 475px;">
                    <h6>Supported By</h6>
                    <h6>CODETREE</h6>
                </center>
            </div>
