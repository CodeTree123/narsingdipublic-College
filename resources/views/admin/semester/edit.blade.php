...
@section('body')
 ...
 <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('admin.semester.update') }}" id="form_validation" method="POST">
              	@csrf
              	<div class="form-group">
                    <label for="exampleInputEmail1">Semester Name</label>
                    <input type="text" class="form-control" name="semestername" value="{{ $cats->semestername }}" id="exampleInputEmail1" placeholder="Enter Name">
