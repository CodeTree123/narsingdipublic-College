...
@section('body')
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>ExamInfo Of <b>Section:</b>{{ $sectionId }},<b>Department:</b>{{ $departmentName }},<b>Semester:</b>{{ $semesterName }}</h5>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2"></div>
           <div class="col-sm-2">
            <a href="{{ route('admin.exam.semester',['id'=>$semesterId]) }}" type="button" class="btn btn-block bg-gradient-success text-light">Previous Page</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
 ...
 <div class="card">
            <div class="card-header">
              <h3 class="card-title">ExamInfo List</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
